...
function afficherMessageAvecDelai(message, langue, classes, delai) {
  ...
  if (
    classes &&
    !classes.includes("chat-personne-en") &&
    !classes.includes("chat-personne-fr")
  ) {
...
function question_1() {
  ...
  setTimeout(function () {
    ...
    afficherMessageAvecDelai(
      "Le brie de Meaux est un fromage au lait cru dont l'appellation d'origine est préservée commercialement via une AOC depuis 1980. Son appellation vient de la région de la Brie et de la commune de Meaux en France.",
      "",
      "chatbot-message fr",
      3000
    );
...
function question_2() {
  ...
  setTimeout(function () {
    ...
    afficherMessageAvecDelai(
      "Il est fabriqué avec 25 litres de lait cru de vache pour un fromage entier d'environ 3,5 kg. Après un écrémage partiel à 40 °C, le lait est emprésuré avec de la présure d'origine bovine uniquement. Ensuite, le caillage se fait à une température inférieure ou égale à 37 ° C.",
      "",
      "chatbot-message fr",
      3000
    );
